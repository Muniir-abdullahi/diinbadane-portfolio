...
export default function ClientProjectItem({ project, index }: ClientProjectItemProps) {
  return (
    <div 
      ...
      className="bg-white dark:bg-slate-800/30 border border-slate-200 dark:border-white/5 shadow-sm dark:shadow-none rounded-xl p-5 mb-3 hover:border-slate-300 dark:hover:bg-slate-800/50 transition-colors flex flex-col md:flex-row justify-between items-start md:items-center gap-4"
    >
      ...
      <div className="flex-shrink-0 md:self-center">
        <span className="bg-emerald-500/10 dark:bg-slate-900/50 border border-emerald-500/15 dark:border-white/5 text-emerald-600 dark:text-slate-300 text-xs px-2.5 py-1 rounded-full font-medium">
          {project.role}
        </span>
      </div>
    </div>
