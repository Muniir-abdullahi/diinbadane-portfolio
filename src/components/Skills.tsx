  ...
  return (
    <div className="bg-white w-full">
      <section id="stack" className="py-24 px-6 max-w-5xl mx-auto container relative">
        ...
        <div className="border border-gray-200 rounded-2xl overflow-hidden bg-white shadow-sm" id="skills-grid">
                  ...
                  <div className="flex flex-col" id={`skill-pills-list-${index}`}>
                    {skillGroup.items.map((item, itemIdx) => (
                      <span
                        ...
                        className="text-sm font-semibold text-gray-900 leading-[1.9]"
                      >
                        {item}
                      </span>
                    ))}
