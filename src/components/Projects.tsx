...
export default function Projects() {
  return (
    <section id="projects" className="py-24 px-6 max-w-5xl mx-auto container space-y-24 relative">
      <div className="absolute top-[40%] right-0 h-[300px] w-[300px] rounded-full bg-primary/5 opacity-10 blur-[100px]" />
      ...
      <div id="projects-own-work" className="space-y-8">
        <div className="border-b border-white/[0.04] pb-4 flex flex-col md:flex-row md:items-end justify-between gap-4">
          <div>
            <h3 className="text-lg font-bold text-white flex items-center gap-2">
              Commercial Products
              <span className="inline-flex items-center gap-1 bg-primary-light border border-primary/20 text-[#2ee59d] rounded-full px-2 py-0.5 text-[9px] font-bold uppercase tracking-wider">
                Active SaaS Suite
              </span>
            </h3>
        ...
        <div className="flex justify-center pt-4" id="own-projects-footer">
          <a
            ...
            target="_blank"
            rel="noopener noreferrer"
            className="inline-flex items-center gap-1.5 text-xs font-bold text-gray-400 hover:text-primary transition-all group bg-white/[0.02] border border-white/[0.05] hover:border-primary/20 rounded-full px-5 py-2.5"
      ...
      <div id="projects-client-work" className="space-y-8 pt-10 border-t border-white/[0.06]">
        <div className="flex flex-col md:flex-row md:items-end justify-between gap-4">
          <div className="max-w-2xl">
            <h3 className="text-lg font-bold text-white flex items-center gap-2">
              Featured Projects & Integrations
              <span className="inline-flex items-center gap-1 bg-amber-950/30 text-amber-500 border border-amber-900/40 rounded-full px-2 py-0.5 text-[9px] font-bold uppercase tracking-widest">
        ...
        {/* NDA notice */}
        <div className="bg-white/[0.01] border border-white/[0.04] p-4 rounded-xl flex items-start gap-3" id="nda-compliance-notice">
